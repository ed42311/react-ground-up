...
var _foo = __webpack_require__(22);
...
var NameBear = function (_Component) {
  _inherits(NameBear, _Component);

  function NameBear() {
    _classCallCheck(this, NameBear);

    var _this = _possibleConstructorReturn(this, (NameBear.__proto__ || Object.getPrototypeOf(NameBear)).call(this));
  ...
  _createClass(NameBear, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;

      _axios2.default.get("/api/bears").then(function (response) {
        _this2.setState({
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        null,
        'NameBear from react!',
        this.state.bearList.map(function (bear) {
          return bear.name;
        })
      );
    }
...
exports.default = NameBear;


(0, _reactDom.render)(_react2.default.createElement(NameBear, null), document.getElementById('bears'));
(0, _foo2.default)();
